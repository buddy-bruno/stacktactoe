...
function ZugangContent() {
  ...
  return (
    <PageShell backHref="/" header={<AppHeader title="Zugang" showRanking showAuth />}>
          ...
          <Card className="w-full max-w-md">
            <CardContent className="space-y-4 pt-6">
              ...
              <p className="text-center text-sm text-game-text-muted">
                Hiermit akzeptiere ich den{' '}
                <Link href="/datenschutz" className="text-game-primary hover:underline">
                  Datenschutz
                </Link>
                .
              </p>
